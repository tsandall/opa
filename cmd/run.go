...
`,
	...
	runCommand.Flags().BoolVar(&cmdParams.rt.SkipVersionCheck, "skip-version-check", false, "disables anonymous version reporting (see: https://openpolicyagent.org/docs/latest/privacy)")
